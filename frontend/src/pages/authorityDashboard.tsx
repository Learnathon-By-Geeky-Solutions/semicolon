  ...
  return (
    <div className="min-h-screen bg-gray-100 flex">
      ...
      <div className="flex-1 p-6">
        <h1 className="text-3xl font-semibold text-green-900 mb-4">Welcome, Authority!</h1>
        <p className="text-lg text-gray-700 mb-8">
          Allocate shelter zones, manage resources, and oversee the disaster response process.
        </p>
