  ...
  return (
    <div className="min-h-screen bg-gray-100 flex">
      ...
      <div className="flex-1 p-6">
        <h1 className="text-3xl font-semibold text-green-900 mb-4">Welcome, Admin!</h1>
        <p className="text-lg text-gray-700 mb-8">
          Manage authorities, shelter zones, and resources effectively.
        </p>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="bg-white p-6 rounded-lg shadow-md">
            <h3 className="text-xl font-semibold text-green-800 mb-4">Manage Authorities</h3>
          ...
          <div className="bg-white p-6 rounded-lg shadow-md">
            <h3 className="text-xl font-semibold text-green-800 mb-4">Manage Resources</h3>
            <button className="w-full px-6 py-3 bg-green-800 text-white rounded-lg hover:bg-green-600 focus:outline-none transition duration-300">
              View Resources
            </button>
          </div>
