...
import { login, signup, logout, checkAuth, googleRedirect, googleCallback, googleCallbackHandler, verifyEmail, forgotPassword } from "../controllers/authenticationController.js";
